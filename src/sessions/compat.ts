...
/**
 * Open or create a SessionStore at the given .codexstory directory root.
 *
 * Migration logic:
 ...
 *
 * @param overstoryDir - Path to the .codexstory directory (e.g., /project/.codexstory)
...
export function openSessionStore(overstoryDir: string): {
	...
	// recorded), fall through to check sessions.json for importable records (codexstory-036f).
