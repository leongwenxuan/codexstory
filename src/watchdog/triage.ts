 ...
 * @param options.root - Project root directory (contains .codexstory/)
...
export async function triageAgent(options: {
	...
	const logsDir = join(root, ".codexstory", "logs", agentName);
 ...
 *
 * @param logsDir - Path to the agent's logs directory (e.g., .codexstory/logs/{agent}/)
