/**
 * Tests for `codexstory inspect` command.
 *
...
describe("inspectCommand", () => {
	...
	describe("help flag", () => {
		test("--help shows help text", async () => {
			...
			const out = output();
			expect(out).toContain("codexstory inspect");
	...
	describe("validation", () => {
		...
		test("throws if --interval is invalid", async () => {
			...
			store.upsert({
				...
				capability: "builder",
				worktreePath: "/tmp/wt",
				branchName: "codexstory/builder-1/test",
				beadId: "codexstory-001",
	...
	describe("gatherInspectData", () => {
		test("gathers basic session data", async () => {
			...
			expect(data.session.beadId).toBe("codexstory-001");
	...
	describe("human-readable output", () => {
		test("displays agent metadata", async () => {
			...
			expect(out).toContain("codexstory-001");
			expect(out).toContain("builder");
			expect(out).toContain("codexstory/builder-1/test");
