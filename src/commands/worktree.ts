/**
 * CLI command: codexstory worktree list | clean [--completed] [--all]
 *
...
/**
 * Handle `codexstory worktree list`.
 */
...
/**
 * Handle `codexstory worktree clean [--completed] [--all] [--force]`.
 */
async function handleClean(
	...
	try {
		for (const wt of overstoryWts) {
			...
			// Always force worktree removal since deployed .codex/ files create untracked
...
/**
 * Entry point for `codexstory worktree <subcommand> [flags]`.
 *
 * Subcommands: list, clean.
 */
const WORKTREE_HELP = `codexstory worktree — Manage agent worktrees

Usage: codexstory worktree <subcommand> [flags]
