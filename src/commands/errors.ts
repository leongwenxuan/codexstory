/**
 * CLI command: codexstory errors [--agent <name>] [--run <id>] [--json] [--since <ts>] [--until <ts>] [--limit <n>]
 *
...
const ERRORS_HELP = `codexstory errors -- Aggregated error view across agents

Usage: codexstory errors [options]
...
/**
 * Entry point for `codexstory errors [--agent <name>] [--run <id>] [--json] [--since] [--until] [--limit]`.
 */
