/**
 * CLI command: codexstory inspect <agent-name>
 *
...
const INSPECT_HELP = `codexstory inspect <agent-name> — Deep inspection of a single agent

Usage: codexstory inspect <agent-name> [options]
...
Examples:
  codexstory inspect builder-1
  codexstory inspect scout-alpha --json
  codexstory inspect builder-1 --follow --interval 2000`;

/**
 * Entry point for `codexstory inspect <agent-name>`.
 */
