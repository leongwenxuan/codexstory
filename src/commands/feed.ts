/**
 * CLI command: codexstory feed [--follow] [--agent <name>...] [--run <id>]
...
const FEED_HELP = `codexstory feed -- Unified real-time event stream across all agents

Usage: codexstory feed [options]
...
/**
 * Entry point for `codexstory feed [--follow] [--agent <name>...] [--run <id>] [--json]`.
 */
