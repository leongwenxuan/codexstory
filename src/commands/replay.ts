/**
 * CLI command: codexstory replay [--run <id>] [--agent <name>...] [--json]
...
const REPLAY_HELP = `codexstory replay -- Interleaved chronological replay across agents

Usage: codexstory replay [options]
...
If neither is specified, tries to read the current run from .codexstory/current-run.txt.
Falls back to a 24-hour timeline of all events.`;

/**
 * Entry point for `codexstory replay [--run <id>] [--agent <name>...] [--json]`.
 */
