/**
 * Tests for codexstory dashboard command.
 *
...
describe("dashboardCommand", () => {
	...
	test("--interval at exactly 500 passes validation", async () => {
		...
		// We chdir to a temp dir WITHOUT .codexstory/config.yaml so that loadConfig()
...
describe("openDashboardStores", () => {
	...
	test("sessionStore is non-null when .codexstory/ has sessions.db", async () => {
		// Create the .codexstory directory and seed a sessions.db via createSessionStore
